...
local settingsList = {
    ...
    book_map = {category="none", event="ShowBookMap", title=_("Book map"), reader=true},
    book_map_overview = {category="none", event="ShowBookMap", arg=true, title=_("Book map (overview)"), reader=true},
    page_browser = {category="none", event="ShowPageBrowser", title=_("Page browser"), reader=true},
